...
% Last Modified by GUIDE v2.5 24-Mar-2021 02:05:25
...
imshow(zeros(100,100,3), 'Parent', handles.axes1)
...
while 1
    ...
    RGB = insertText(vid_img,position,['Force: ' num2str(5*value,'%0.2f') '%'],'FontSize',18,'BoxColor',box_color,'BoxOpacity',0.4,'TextColor','white');
